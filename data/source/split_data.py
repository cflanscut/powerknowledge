...
train_size = 0.8
test_size = 0.3
old_path = 'data/source/submetered_new_pured/feature_process'
new_path = 'data/source/submetered_new_pured/feature_process/total'
test_path = 'data/source/submetered_new_pured/feature_process/testing'
train_path = 'data/source/submetered_new_pured/feature_process/training'
validation_path = 'data/source/submetered_new_pured/feature_process/validation'
