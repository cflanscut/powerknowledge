...
x, y = read_processed_data('is_cool',
...
x = x[:, 1:]
np.savetxt('model/knowledge_model/cooler/y_label.csv', y, delimiter=',')
np.savetxt('model/knowledge_model/cooler/x.csv', x, delimiter=',')
